...
# Fonction pour exécuter le code de votre script
def execute_script():
...
# Boucle principale pour exécuter le code toutes les 24 heures
while True:
    execute_script()  # Exécutez le code
    time.sleep(600)  # Mettez en pause le script pendant 24 heures (en secondes)
